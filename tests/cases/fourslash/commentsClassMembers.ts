...
verify.signatureHelp({ marker: "47", docComment: "", parameterDocComment: "" });
verify.quickInfos({
...
verify.signatureHelp({ marker: "54", docComment: "", parameterDocComment: "" });
verify.quickInfos({
...
verify.signatureHelp({ marker: "61", docComment: "", parameterDocComment: "" });
verify.quickInfos({
    "61q": "(method) c1.nc_s2(b: number): number",
    62: "(property) c1.nc_s3: number"
});

verify.signatureHelp({ marker: "63", docComment: "", parameterDocComment: "" });
verify.completionListContains("value", "(parameter) value: number", "");
verify.quickInfos({
...
verify.signatureHelp({ marker: "81", docComment: "", parameterDocComment: "" });
...
verify.signatureHelp({ marker: "102", docComment: "", parameterDocComment: "" });
verify.quickInfos({
