...
verify.signatureHelp({ marker: "4", docComment: "", parameterDocComment: "" });
verify.signatureHelp({ marker: "o4", docComment: "this is signature 1", parameterDocComment: "param a" });
...
verify.signatureHelp(
    { marker: "8", docComment: "this is signature 2", parameterDocComment: "" },
    { marker: "o8", docComment: "", parameterDocComment: "param a" },
);
...
verify.signatureHelp({ marker: ["12", "o12"], docComment: "", parameterDocComment: "" });
...
verify.signatureHelp(
    { marker: "16", docComment: "this is signature 4 - with string parameter", parameterDocComment: "" },
    { marker: "o16", docComment: "this is signature 4 - with number parameter", parameterDocComment: "param a" },
);
...
verify.signatureHelp({ marker: "19", docComment: "", parameterDocComment: "" });
verify.quickInfoAt("19q", "var i1_i: i1\nnew (b: number) => any (+1 overload)");

verify.signatureHelp({ marker: "20", docComment: "new 1", parameterDocComment: "" });
verify.quickInfoAt("20q", "var i1_i: i1\nnew (a: string) => any (+1 overload)", "new 1");

verify.signatureHelp({ marker: "21", docComment: "this signature 1", parameterDocComment: "param a" });
verify.quickInfoAt("21q", "var i1_i: i1\n(a: number) => number (+1 overload)", "this signature 1");

verify.signatureHelp({ marker: "22", docComment: "this is signature 2", parameterDocComment: "" });
goTo.marker('22q');
...
verify.signatureHelp({ marker: "24", docComment: "foo 1", parameterDocComment: "" });
verify.quickInfoAt("24q", "(method) i1.foo(a: number): number (+1 overload)", "foo 1");

verify.signatureHelp({ marker: "25", docComment: "foo 2", parameterDocComment: "" });
verify.quickInfoAt("25q", "(method) i1.foo(b: string): number (+1 overload)", "foo 2");

verify.signatureHelp({ marker: "26", docComment: "", parameterDocComment: "" });
verify.quickInfoAt("26q", "(method) i1.foo2(a: number): number (+1 overload)");

verify.signatureHelp({ marker: "27", docComment: "foo2 2", parameterDocComment: "" });
verify.quickInfoAt("27q", "(method) i1.foo2(b: string): number (+1 overload)", "foo2 2");

verify.signatureHelp({ marker: "28", docComment: "", parameterDocComment: "" });
verify.quickInfoAt("28q", "(method) i1.foo3(a: number): number (+1 overload)");

verify.signatureHelp({ marker: "29", docComment: "", parameterDocComment: "" });
verify.quickInfoAt("29q", "(method) i1.foo3(b: string): number (+1 overload)");

verify.signatureHelp({ marker: "30", docComment: "foo4 1", parameterDocComment: "" });
verify.quickInfoAt("30q", "(method) i1.foo4(a: number): number (+1 overload)", "foo4 1");

verify.signatureHelp({ marker: "31", docComment: "", parameterDocComment: "" });
verify.quickInfoAt("31q", "(method) i1.foo4(b: string): number (+1 overload)");

verify.signatureHelp({ marker: "", docComment: "new 2", parameterDocComment: "" });
verify.quickInfoAt("32q", "var i2_i: i2\nnew (b: number) => any (+1 overload)", "new 2");

verify.signatureHelp({ marker: "33", docComment: "", parameterDocComment: "" });
verify.quickInfoAt("33q", "var i2_i: i2\nnew (a: string) => any (+1 overload)");

verify.signatureHelp({ marker: "34", docComment: "", parameterDocComment: "" });
verify.quickInfoAt("34q", "var i2_i: i2\n(a: number) => number (+1 overload)");

verify.signatureHelp({ marker: "35", docComment: "this is signature 2", parameterDocComment: "" });
verify.quickInfoAt("35q", "var i2_i: i2\n(b: string) => number (+1 overload)", "this is signature 2");

verify.signatureHelp({ marker: "36", docComment: "new 2", parameterDocComment: "" });
verify.quickInfoAt("36q", "var i3_i: i3\nnew (b: number) => any (+1 overload)", "new 2");

verify.signatureHelp({ marker: "37", docComment: "new 1", parameterDocComment: "" });
verify.quickInfoAt("37q", "var i3_i: i3\nnew (a: string) => any (+1 overload)", "new 1");

verify.signatureHelp({ marker: "38", docComment: "this is signature 1", parameterDocComment: "" });
verify.quickInfoAt("38q", "var i3_i: i3\n(a: number) => number (+1 overload)", "this is signature 1");

verify.signatureHelp({ marker: "39", docComment: "", parameterDocComment: "" });
verify.quickInfoAt("39q", "var i3_i: i3\n(b: string) => number (+1 overload)");

verify.signatureHelp({ marker: "40", docComment: "", parameterDocComment: "" });
verify.quickInfoAt("40q", "var i4_i: i4\nnew (b: number) => any (+1 overload)");

verify.signatureHelp({ marker: "41", docComment: "", parameterDocComment: "" });
verify.quickInfoAt("41q", "var i4_i: i4\nnew (a: string) => any (+1 overload)");

verify.signatureHelp({ marker: "42", docComment: "", parameterDocComment: "" });
verify.quickInfoAt("42q", "var i4_i: i4\n(a: number) => number (+1 overload)");

verify.signatureHelp({ marker: "43", docComment: "", parameterDocComment: "" });
...
verify.signatureHelp({ marker: "45", docComment: "", parameterDocComment: "" });
verify.quickInfoAt("45q", "(method) c.prop1(a: number): number (+1 overload)");

verify.signatureHelp({ marker: "46", docComment: "", parameterDocComment: "" });
verify.quickInfoAt("46q", "(method) c.prop1(b: string): number (+1 overload)");

verify.signatureHelp({ marker: "47", docComment: "prop2 1", parameterDocComment: "" });
verify.quickInfoAt("47q", "(method) c.prop2(a: number): number (+1 overload)", "prop2 1");

verify.signatureHelp({ marker: "48", docComment: "", parameterDocComment: "" });
verify.quickInfoAt("48q", "(method) c.prop2(b: string): number (+1 overload)");

verify.signatureHelp({ marker: "49", docComment: "", parameterDocComment: "" });
verify.quickInfoAt("49q", "(method) c.prop3(a: number): number (+1 overload)");

verify.signatureHelp({ marker: "50", docComment: "prop3 2", parameterDocComment: "" });
verify.quickInfoAt("50q", "(method) c.prop3(b: string): number (+1 overload)", "prop3 2");

verify.signatureHelp({ marker: "51", docComment: "prop4 1", parameterDocComment: "" });
verify.quickInfoAt("51q", "(method) c.prop4(a: number): number (+1 overload)", "prop4 1");

verify.signatureHelp({ marker: "52", docComment: "prop4 2", parameterDocComment: "" });
verify.quickInfoAt("52q", "(method) c.prop4(b: string): number (+1 overload)", "prop4 2");

verify.signatureHelp({ marker: "53", docComment: "prop5 1", parameterDocComment: "" });
verify.quickInfoAt("53q", "(method) c.prop5(a: number): number (+1 overload)", "prop5 1");

verify.signatureHelp({ marker: "54", docComment: "prop5 2", parameterDocComment: "" });
verify.quickInfoAt("54q", "(method) c.prop5(b: string): number (+1 overload)", "prop5 2");

verify.signatureHelp({ marker: "55", docComment: "", parameterDocComment: "" });
verify.quickInfoAt("55q", "constructor c1(a: number): c1 (+1 overload)");

verify.signatureHelp({ marker: "56", docComment: "", parameterDocComment: "" });
verify.quickInfoAt("56q", "constructor c1(b: string): c1 (+1 overload)");

verify.signatureHelp({ marker: "57", docComment: "c2 1", parameterDocComment: "" });
verify.quickInfoAt("57q", "constructor c2(a: number): c2 (+1 overload)", "c2 1");

verify.signatureHelp({ marker: "58", docComment: "", parameterDocComment: "" });
verify.quickInfoAt("58q", "constructor c2(b: string): c2 (+1 overload)");

verify.signatureHelp({ marker: "59", docComment: "", parameterDocComment: "" });
verify.quickInfoAt("59q", "constructor c3(a: number): c3 (+1 overload)");

verify.signatureHelp({ marker: "60", docComment: "c3 2", parameterDocComment: "" });
verify.quickInfoAt("60q", "constructor c3(b: string): c3 (+1 overload)", "c3 2");

verify.signatureHelp({ marker: "61", docComment: "c4 1", parameterDocComment: "" });
verify.quickInfoAt("61q", "constructor c4(a: number): c4 (+1 overload)", "c4 1");

verify.signatureHelp({ marker: "62", docComment: "c4 2", parameterDocComment: "" });
verify.quickInfoAt("62q", "constructor c4(b: string): c4 (+1 overload)", "c4 2");

verify.signatureHelp({ marker: "63", docComment: "c5 1", parameterDocComment: "" });
verify.quickInfoAt("63q", "constructor c5(a: number): c5 (+1 overload)", "c5 1");

verify.signatureHelp({ marker: "64", docComment: "c5 2", parameterDocComment: "" });
